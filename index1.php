...
<html lang="en">
  ...
  <body id="page-top" style= "background-image: url('home.jpg');background-repeat: no-repeat;
            ...
            <?php 
              if(empty($_SESSION['username'])){
                echo '<li class="nav-item">';
                  echo '<a class="nav-link" href="./auth/login.php">Sign in</a>';
                echo '</li>';
              }else{
                echo '<li class="nav-item">';
...
<br>
            ...
            <?php
              if(isset($errMsg)){
                echo '<div style="color:#39A2DB;text-align:center;font-size:17px;">'.$errMsg.'</div>';
              }
              if(count($data) !== 0){
    ...
    <!-- Footer -->
    <footer style="background-color: #39A2DB;">
      <div class="container">
        <div class="row">
          <div class="col-md-4">
